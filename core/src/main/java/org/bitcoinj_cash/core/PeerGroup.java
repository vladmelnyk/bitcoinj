...
import org.bitcoinj_cash.net.*;
import org.bitcoinj_cash.net.discovery.*;
...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * {@link org.bitcoinj_cash.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.bitcoinj_cash.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.bitcoinj_cash.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.bitcoinj_cash.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.bitcoinj_cash.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.bitcoinj_cash.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.bitcoinj_cash.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.bitcoinj_cash.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.bitcoinj_cash.core.Peer#ping()}.
     */
