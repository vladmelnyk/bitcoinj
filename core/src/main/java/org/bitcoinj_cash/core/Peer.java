 ...
 * {@link org.bitcoinj_cash.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.bitcoinj_cash.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.bitcoinj_cash.net.NioClientManager#openConnection(java.net.SocketAddress, StreamConnection)}
     * or
     * {@link org.bitcoinj_cash.net.NioClient#NioClient(java.net.SocketAddress, StreamConnection, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.bitcoinj_cash.core.TxConfidenceTable}
     ...
     * Once the pong is received the value returned by {@link org.bitcoinj_cash.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.bitcoinj_cash.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.bitcoinj_cash.core.Peer#ping()} has never
