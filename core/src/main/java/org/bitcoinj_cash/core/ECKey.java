...
import org.bitcoin_cash.NativeSecp256k1;
import org.bitcoin_cash.NativeSecp256k1Util;
import org.bitcoin_cash.Secp256k1Context;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.bitcoinj_cash.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * usually encoded using ASN.1 format, so you want {@link org.bitcoinj_cash.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.bitcoinj_cash.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * @throws org.bitcoinj_cash.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
     ...
     * the {@link org.bitcoinj_cash.core.DumpedPrivateKey#toString()} method to get the string.
     *
