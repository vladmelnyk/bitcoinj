...
package org.bitcoinj_cash.wallet;
...
import org.bitcoinj_cash.core.listeners.*;
import org.bitcoinj_cash.core.AbstractBlockChain;
import org.bitcoinj_cash.core.Address;
import org.bitcoinj_cash.core.BlockChain;
import org.bitcoinj_cash.core.BloomFilter;
import org.bitcoinj_cash.core.Coin;
import org.bitcoinj_cash.core.Context;
import org.bitcoinj_cash.core.ECKey;
import org.bitcoinj_cash.core.FilteredBlock;
import org.bitcoinj_cash.core.InsufficientMoneyException;
import org.bitcoinj_cash.core.Message;
import org.bitcoinj_cash.core.NetworkParameters;
import org.bitcoinj_cash.core.Peer;
import org.bitcoinj_cash.core.PeerFilterProvider;
import org.bitcoinj_cash.core.PeerGroup;
import org.bitcoinj_cash.core.ScriptException;
import org.bitcoinj_cash.core.Sha256Hash;
import org.bitcoinj_cash.core.StoredBlock;
import org.bitcoinj_cash.core.Transaction;
import org.bitcoinj_cash.core.TransactionBag;
import org.bitcoinj_cash.core.TransactionBroadcast;
import org.bitcoinj_cash.core.TransactionBroadcaster;
import org.bitcoinj_cash.core.TransactionConfidence;
import org.bitcoinj_cash.core.TransactionInput;
import org.bitcoinj_cash.core.TransactionOutPoint;
import org.bitcoinj_cash.core.TransactionOutput;
import org.bitcoinj_cash.core.UTXO;
import org.bitcoinj_cash.core.UTXOProvider;
import org.bitcoinj_cash.core.UTXOProviderException;
import org.bitcoinj_cash.core.Utils;
import org.bitcoinj_cash.core.VarInt;
import org.bitcoinj_cash.core.VerificationException;
import org.bitcoinj_cash.core.TransactionConfidence.*;
import org.bitcoinj_cash.crypto.*;
import org.bitcoinj_cash.script.*;
import org.bitcoinj_cash.signers.*;
import org.bitcoinj_cash.utils.*;
import org.bitcoinj_cash.wallet.Protos.Wallet.*;
import org.bitcoinj_cash.wallet.WalletTransaction.*;
...
import org.bitcoinj_cash.wallet.listeners.WalletEventListener;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoinj_cash.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.bitcoinj_cash.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.bitcoinj_cash.wallet.KeyChain.KeyPurpose)} with
     * {@link org.bitcoinj_cash.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.bitcoinj_cash.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.bitcoinj_cash.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.bitcoinj_cash.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.bitcoinj_cash.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.bitcoinj_cash.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.bitcoinj_cash.crypto.KeyCrypter,
     ...
     * {@link org.bitcoinj_cash.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link org.bitcoinj_cash.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.bitcoinj_cash.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.bitcoinj_cash.signers.TransactionSigner.MissingSignatureException}
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.bitcoinj_cash.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.bitcoinj_cash.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
