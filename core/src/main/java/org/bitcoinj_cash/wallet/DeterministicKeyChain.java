 ...
 * {@link org.bitcoinj_cash.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.bitcoinj_cash.crypto.MnemonicCode},
 ...
 * {@link org.bitcoinj_cash.crypto.DeterministicKey#serializePubB58(org.bitcoinj_cash.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.bitcoinj_cash.crypto.DeterministicKey#deserializeB58(org.bitcoinj_cash.crypto.DeterministicKey, String, org.bitcoinj_cash.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.bitcoinj_cash.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.bitcoinj_cash.crypto.DeterministicHierarchy} and
 * {@link org.bitcoinj_cash.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.bitcoinj_cash.crypto.DeterministicKey)}
     ...
     * @see org.bitcoinj_cash.wallet.MarriedKeyChain
     */
