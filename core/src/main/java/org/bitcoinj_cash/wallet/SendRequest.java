...
import org.bitcoin_cash.protocols.payments.Protos.PaymentDetails;
...
import org.bitcoinj_cash.wallet.KeyChain.KeyPurpose;
import org.bitcoinj_cash.wallet.Wallet.MissingSigsMode;
...
public class SendRequest {
     ...
     * (its value is ignored and set to {@link org.bitcoinj_cash.wallet.Wallet#getBalance()} - the fees required
    ...
    /**
     * If not null, the {@link org.bitcoinj_cash.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
