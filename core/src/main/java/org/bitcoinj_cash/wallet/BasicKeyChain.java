...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.bitcoinj_cash.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.bitcoinj_cash.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(org.bitcoinj_cash.crypto.KeyCrypter,
