...
public abstract class DatabaseFullPrunedBlockStore implements FullPrunedBlockStore {
    ...
    /**
     * Create a new store for the given {@link org.bitcoinj_cash.core.NetworkParameters}.
     ...
     *
     * <p>The balance {@link org.bitcoinj_cash.store.DatabaseFullPrunedBlockStore#getBalanceSelectSQL()} returns
