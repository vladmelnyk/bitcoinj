...
import org.bitcoinj_cash.testing.TestWithWallet;
...
import org.bitcoinj_cash.wallet.WalletFiles;
...
import static org.bitcoinj_cash.protocols.channels.PaymentChannelCloseException.CloseReason;
import static org.bitcoinj_cash.testing.FakeTxBuilder.createFakeBlock;
import static org.bitcoin_cash.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.bitcoinj_cash.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
